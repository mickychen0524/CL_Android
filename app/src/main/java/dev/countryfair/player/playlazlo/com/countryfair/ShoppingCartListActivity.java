...
public class ShoppingCartListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter = new ShoppingCartListAdapter(this, loadAllShoppingCartData());
        ...
        mAdapter.setOnDataChangeListener(new ShoppingCartListAdapter.OnDataChangeListener() {
                            ...
                            if (receivedObj != null) {
                                try {
                                    ...
                                    if (jsonData != null) {
                                        ...
                                        new PromptDialog(ShoppingCartListActivity.this)
    ...
    private void getCheckoutStatus(JSONObject obj) {
        if (!b_cancelBtnPressed) {
            ...
            mServiceIntent = new Intent(ShoppingCartListActivity.this, CheckoutStatusGettingService.class);
            CheckoutStatusGettingService.shoppingCartData = shoppingCartData;
            try {
            ...
            CheckoutStatusGettingService.isStoped = false;
            ShoppingCartListActivity.this.startService(mServiceIntent);
        } else {
            b_cancelBtnPressed = false;
        }
    }
            ...
            public void onReceiveResult(int resultCode, Bundle resultData) {
                if (resultCode == RESULT_OK) {
                    ...
                    try{
                        ...
                        Intent i = new Intent(ShoppingCartListActivity.this, CheckoutFileDownloadActivity.class);
...
//                                finish();
                    ...
                    runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            if (receivedObj != null) {
                                    ...
                                    if (jsonData != null) {
                                        ...
                                        dialog.setPositiveListener("Try again", new ColorDialog.OnPositiveListener() {
                                            ...
                                            public void onClick(ColorDialog dialog) {
                                                CheckoutStatusGettingService.isStoped = true;
                                                cancelCheckout(obj);
                                                dialog.dismiss();
                                ...
                                ColorDialog dialog = new ColorDialog(ShoppingCartListActivity.this);
                                dialog.setTitle("Checkout cancel error");
                                dialog.setContentText("Oops! We seem to be having a problem connecting.\n Please try again later.");
                                dialog.setPositiveListener("Try again", new ColorDialog.OnPositiveListener() {
                                    @Override
    ...
    private void createCheckoutDlg(final JSONObject obj) {
        ...
        checkoutDlg.show();
        AndroidUtilities.setDialogLayoutParams(ShoppingCartListActivity.this,checkoutDlg);
    }
    ...
    private void createTicketGeneratingDlg() {
        ...
        generatingDlg.show();
        AndroidUtilities.setDialogLayoutParams(ShoppingCartListActivity.this,generatingDlg);
    }

    private List<JSONObject> loadAllShoppingCartData() {
        f_totalPrice = 0.0f;
        i_totalCount = 0;
        shoppingCartArr = new AppHelper(this).getShoppingCartDataFromLocal();
        shoppingCartData = AppHelper.parseFromJsonList(shoppingCartArr);

        for (JSONObject obj : shoppingCartData) {
            try {
                double d_amount = obj.getDouble("playAmount");
                int i_numberOfPlays = obj.getInt("panelCount");

                f_totalPrice += d_amount * i_numberOfPlays;
                i_totalCount += i_numberOfPlays;
        ...
        shoppingCartCountBtn.setText(String.valueOf(i_totalCount));
    ...
    private void createHelpOverlayView () {
        ...
        helpTxt.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                SharedPreferences sharedPref = PreferenceManager.getDefaultSharedPreferences(ShoppingCartListActivity.this.getApplicationContext());
